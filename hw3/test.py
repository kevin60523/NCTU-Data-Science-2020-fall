...
from cv2 import resize, GaussianBlur, subtract, KeyPoint, INTER_LINEAR, INTER_NEAREST, imwrite, imread
...
def generateGaussianImages(image, num_octaves, gaussian_kernels):
    ...
    for octave_index in range(num_octaves):
        ...
        for gaussian_kernel in gaussian_kernels[1:]:
            ...
            imwrite('./answer/'+str(octave_index)+str(gaussian_kernel)+'.jpg', image)
...
if __name__ == '__main__':
    img1 = imread('./parrington/1.jpg', 0)
    
    computeKeypointsAndDescriptors(img1)